use iced;
use iced::Element;
use iced::widget::{Column, column, text, text_input, combo_box};

use http::Method as Method;
...
impl GUI {
    ...
    fn view(&self) -> Element<Message> {
        column![
            ...
            GUI::label("Method:"),
            combo_box(&self.methods, "Method", self.method_selected.as_ref(), Message::MethodChanged)
        ]
        .into()
    }
